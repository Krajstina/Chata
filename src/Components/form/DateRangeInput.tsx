...
const DateInput = (props: DateInputProps) => {
  ...
  const ExampleCustomInput = forwardRef(({ value, onClick }, ref) => (
    <button
      type="button"
      className="example-custom-input w-full rounded-md border bg-white py-3 px-3  text-base text-left text-gray-400 outline-none focus:border-orange-4000 focus:shadow-md"
      onClick={onClick}
      // @ts-ignore
      ref={ref}
    >
  ...
  return (
    ...
    <div className="DateInput grid grid-flow-col gap-4 lg:grid-cols-30 lg:gap-16">
      <div>
