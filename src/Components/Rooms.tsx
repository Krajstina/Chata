  ...
  return (
    <div className="Rooms w-full h-screen flex flex-col lg:p-0  justify-center overflow-hidden items-center gap-12 bg-green-100/50">
      <div className="relative w-full  h-full">
        ...
        >
          <h4 className="text-gray-800 lg:text-[70px] font-bold font-roboto pt-14">
            Detail izby:
          </h4>
          ...
          <div className="flex flex-row items-center justify-center gap-12">
            <button
              type={"submit"}
              onClick={onSubmit}
              className="bg-green-800 lg:py-4 lg:px-10 px-6 py-1 rounded-full text-white font-bold font-roboto lg:text-12 text-6"
            >
              Vybrat
            </button>
            <button type={"button"} onClick={resetRoom}>
              <ChevronLeftIcon
                className={" bg-red-500 rounded-full h-8 p-2 lg:p-2 text-white lg:w-20 lg:h-14"}
              />
            </button>
          </div>
        </section>
